...
export default connect("dashboard,active_product_id,user_id, nama_produk, category, harga, stok, berat, gambar, preview_1, preview_2, preview_3,description, listProduk", actions)(withRouter(UpdateUser))
