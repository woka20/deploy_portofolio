        ...
        return( 
            <React.Fragment>
                ...
                <Form onSubmit={event=> event.preventDefault()}>
                    ...
                    <Button variant="outline-info" type="submit" onClick={() => this.postProductByUser()}>
...
export default connect("user_id, nama_produk, category, harga, stok, berat, gambar, preview_1, preview_2, preview_3,description", actions)(withRouter(User))
